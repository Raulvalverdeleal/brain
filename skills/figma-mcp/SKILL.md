...
python3 scripts/figma_api.py <tool> [args...]
```
...
### 2. Inspect frames
```bash
python3 scripts/figma_api.py figma_read_nodes <file_key> <node_ids_csv> [depth]
```
...
```bash
python3 scripts/figma_api.py figma_export_images <file_key> <node_ids_csv> png 1
```
...
### 4. Download assets
```bash
python3 scripts/figma_api.py figma_export_images <file_key> <svg_ids_csv> svg
python3 scripts/figma_api.py figma_export_images <file_key> <img_ids_csv> png 2
```
